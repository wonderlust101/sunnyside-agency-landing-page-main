...
import sugarImageMobile from '/images/mobile/image-gallery-sugar-cubes.jpg';
import sugarImageDesktop from '/images/desktop/image-gallery-sugar-cubes.jpg';
    ...
    return (
        <footer className="footer grid-bleed">
            ...
            <div className="footer__content">
                <svg className='footer__logo' viewBox="0 0 124 24" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div className="footer__socials">
                    <FacebookIcon className="#2C7566"/>
                    <InstagramIcon className="#2C7566"/>
                    <TwitterIcon className="#2C7566"/>
                    <PinterestIcon className="#2C7566"/>
                </div>
            </div>
        </footer>
    )
